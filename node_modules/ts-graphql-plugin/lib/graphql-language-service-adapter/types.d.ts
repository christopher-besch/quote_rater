...
export declare type GetQuickInfoAtPosition = ts.LanguageService['getQuickInfoAtPosition'];
export interface AnalysisContext {
    ...
    findTemplateNode(fileName: string, position: number): ts.NoSubstitutionTemplateLiteral | ts.TemplateExpression | undefined;
