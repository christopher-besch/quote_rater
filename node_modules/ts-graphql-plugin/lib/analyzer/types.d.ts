...
export declare type OperationType = 'query' | 'mutation' | 'subscription' | 'fragment' | 'complex' | 'other';
export declare type TsGraphQLPluginConfig = Omit<TsGraphQLPluginConfigOptions, 'typegen'> & {
    typegen: {
