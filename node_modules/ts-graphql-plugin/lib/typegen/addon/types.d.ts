...
import type { GraphQLSchema, GraphQLObjectType, GraphQLUnionType, GraphQLInterfaceType, GraphQLScalarType } from 'graphql/type';
...
declare type GraphQLFragmentTypeConditionNamedType = GraphQLObjectType | GraphQLUnionType | GraphQLInterfaceType;
declare type ToStrict<T> = {
    [P in keyof T]-?: T[P];
};
export declare type StrictAddon = ToStrict<TypeGenVisitorAddon>;
/**
 *
 ...
 *
 */
export declare type CustomScalarOutput = void | ts.TypeNode;
/**
 *
