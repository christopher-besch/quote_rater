...
async function processNodeManifests() {
  ...
  _reporter.default.info((!verboseLogs && listOfUniqueErrorIds.size > 0 ? `unstable_createNodeManifest produced warnings [${[...listOfUniqueErrorIds].join(`, `)}]. ` : ``) + `Visit https://gatsby.dev/nodemanifest for more info on Node Manifests`); // clean up all pending manifests from the store
